<div class="container">
	<form action="<?= baseUrl().'/users/profile/'.$user['id']; ?>" class="form-register" method="post" enctype="multipart/form-data">
		...
		<div class="form-group row">
			<label for="username" class="col-3 col-form-label text-right hidden-sm-down">Имя пользователя</label>
		...
		<div class="form-group row">
			<label for="email" class="col-3 col-form-label text-right hidden-sm-down">Email</label>
			<div class="col-md-9 col-sm-12">
				<input type="email" class="form-control" name="email" id="email" placeholder="Email" value="<?= setValue('email', $user['email']) ?>" required>
			</div>
		</div>
		<div class="form-group row">
			<label for="role_id" class="col-3 text-right hidden-sm-down">Роль</label>
			<div class="col-md-9 col-sm-12">
		...
		<div class="form-group row">
			<label for="avatar" class="col-3 col-form-label text-right hidden-sm-down">Аватар</label>
			<div class="col-md-9 col-sm-12">
				<div class="upload">
		...
		<div class="form-group row">
			<label for="new_pswd" class="col-3 col-form-label text-right hidden-sm-down">Новый пароль</label>
			<div class="col-md-9 col-sm-12">
				<input type="password" class="form-control" name="new_pswd" id="new_pswd" placeholder="Новый пароль">
			</div>
		</div>
		<div class="form-group row">
			<label for="pswd_confirm" class="col-3 col-form-label text-right hidden-sm-down">Подтверждение пароля</label>
			<div class="col-md-9 col-sm-12">
